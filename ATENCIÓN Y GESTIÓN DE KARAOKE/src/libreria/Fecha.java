...
public class Fecha {
	...
	public static String Aumentardia(String fecha){
		int dd = Integer.parseInt(fecha.substring(0,1));
		int mm = Integer.parseInt(fecha.substring(3,4));
		int aa = Integer.parseInt(fecha.substring(5,8));
		switch(dd){
		case 28: if(mm==2){dd=1;mm++;break;}
		case 30: if(mm==4||mm==6||mm==9||mm==11){dd=1;mm++;break;}
		case 31: if(mm==1||mm==3||mm==5||mm==7||mm==8||mm==10){dd=01; mm++;break;}
		else{dd=01;aa++;mm++;break;}
		default: dd++;break;
		}
		return ajustar(dd) + "/" + ajustar(mm) + "/" + aa;
	}
